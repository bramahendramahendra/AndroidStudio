...
function resizeWidth() {
  var windowWidth = $(window).width() + "px";
  if (sidenav.length) {
    //var int_sidenavWidth = parseInt(sidenav.css("width")) + 100;
    //var sidenavWidth = String(int_sidenavWidth + "px") //sidenav.css("width")
    var sidenavWidth = sidenav.css("width");
    //console.log(String(int_sidenavWidth));
...
  //$("#side-nav").css({width:sidenavWidth});
